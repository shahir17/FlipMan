...
class ASASHero: SKSpriteNode {
    ...
    func loadAppearance() {
        ...
        arm = SKSpriteNode(color: armColor, size: CGSize(width: 0, height: 14))
    ...
    func flip() {
        ...
        let translate = SKAction.moveBy(x: 0, y: scale*(size.height + kASASGroundHeight), duration: 0.1)
